...
endpoints** based on https://learn.microsoft.com/en-us/microsoftteams/rooms/security?tabs=Windows#network-security-1 and https://learn.microsoft.com/en-us/microsoftteams/rooms/security?tabs=Android#network-security-1 - core Teams client sign-in, Microsoft Store (AppInstallManager),
...
- Windows Update representative concrete hosts (TCP 80/443):
  ...
  `download.microsoft.com`, `wustat.windows.com`,
  `ntservicepack.microsoft.com`, `go.microsoft.com`, and
...
2. **TCP connectivity** on the relevant ports:
   ...
   - `80`   HTTP (Microsoft Store AppInstallManager)
